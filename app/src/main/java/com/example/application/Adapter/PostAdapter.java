    ...
    public void onBindViewHolder(@NonNull final Viewholder holder, final int position) {
        ...
        holder.username.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((FragmentActivity)mContext).getSupportFragmentManager().beginTransaction().replace(R.id.fragmentConstain,new ProfileFragment()).commit();
        ...
        holder.postImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((FragmentActivity) mContext).getSupportFragmentManager()
                        .beginTransaction().replace(R.id.fragmentConstain,new PostDetailFragment()).commit();
            }
        });
...
private void isSaved(final String postId, final ImageView image) {
                     FirebaseDatabase.getInstance().getReference().child("Saves").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
                         ...
                         public void onDataChange(@NonNull DataSnapshot snapshot) {
                             ...
                             {
                                 image.setImageResource(R.drawable.ic_mybookmark_foreground);
                                 image.setTag("saved");
                             }
                             else
                             {
...
private void isLiked(String postId, final ImageView imageView)
{
    FirebaseDatabase.getInstance().getReference().child("Likes").child(postId).addValueEventListener(new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot snapshot) {
            ...
            {
                imageView.setImageResource(R.drawable.ic_love_foreground);
